...
def post_init_hook(cr, registry):
    ...
    def create_rma_picking_types(whs):
        ...
        for picking_type, values in create_data.items():
            if (
                picking_type in ["rma_supplier_in_type_id", "rma_supplier_out_type_id"]
        ...
        if data:
            whs.write(data)
        whs.rma_supplier_in_type_id.return_picking_type_id = whs.rma_supplier_out_type_id.id
        whs.rma_supplier_out_type_id.return_picking_type_id = whs.rma_supplier_in_type_id.id
